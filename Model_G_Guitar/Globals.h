...
#define TAP_LOW                 0xC0  // ~12.0g force (least sensitive, highest force required)
#define TAP_MED                 0x80  // ~8.0g force (medium sensitivity)
#define TAP_HIGH                0x50  // ~5.0g force (high sensitivity)
